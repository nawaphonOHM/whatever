...
func assertBasicState(t *testing.T, c *Context, value any, now time.Time) {
...
func assertTypedState(t *testing.T, c *Context) {
...
func assertMapState(t *testing.T, c *Context) {
